...
const SUPABASE_BUCKET = process.env.SUPABASE_BUCKET || 'Announcement_images'
...
/**
 * บันทึกไฟล์ที่ upload ขึ้น Supabase Storage
 * - Bucket: Announcement_images (public)
 * - ลบไฟล์ท้องถิ่นหลังอัปโหลดเสร็จ
 */
