...
const create = async (req, res) => {
  try {
    const { trackingNumber, carrier, unitNumber, storageLocation, photoUrl } = req.body
    ...
    const item = await service.createParcel({ trackingNumber, carrier, unitNumber, storageLocation, photoUrl })
